          ...
          >
            <div className="flex items-start gap-4">
              <div className="bg-blue-zunopay/20 p-3 rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-zunopay" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="flex-1">
                <Text as="h4" styleVariant="body-large" className="font-medium text-white group-hover:text-blue-zunopay transition-colors">
                  Scan QR Code
                </Text>
                <Text as="p" styleVariant="body-small" className="mt-1 text-gray-400">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <Text as="p" styleVariant="body-small" className="mt-1 text-gray-400">
                  Transfer funds directly to another wallet address or bank account.
                </Text>
              </div>
              <div className="text-gray-400 group-hover:text-blue-zunopay transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
